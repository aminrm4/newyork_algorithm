...
Test cases live under `tests/` and are organized **by project round**, mirroring the deliverable structure of the course (`test_round1.cpp`, `test_round3.cpp`, etc.), so each file validates exactly the tasks completed in that round.
